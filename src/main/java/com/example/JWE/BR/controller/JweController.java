...
import com.example.JWE.BR.dto.DecryptRequest;
...
public class JweController {
    ...
    public String encrypt(@RequestBody String json) throws Exception {
        ...
        PublicKey serverPublicKey = getPublicKeyFromString(PUBLIC_KEY);
        ...
        return "Encrypted JSON: " + encryptedJson + "\nEncrypted Secret Key: " + encryptedSecretKey + "decript: " + decryptedMessage;
    }
